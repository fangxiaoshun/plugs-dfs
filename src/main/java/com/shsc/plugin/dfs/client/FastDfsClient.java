package com.shsc.plugin.dfs.client;

import com.shsc.plugin.dfs.common.MyException;
import com.shsc.plugin.dfs.common.NameValuePair;
import com.shsc.plugin.dfs.core.TrackerServerPool;
import com.shsc.plugin.dfs.error.ErrorCode;
import com.shsc.plugin.dfs.exception.FastDfsException;
import com.shsc.plugin.dfs.fastdfs.FileInfo;
import com.shsc.plugin.dfs.fastdfs.ProtoCommon;
import com.shsc.plugin.dfs.fastdfs.StorageClient1;
...
/**
 * FastDfsClient Java API. 文件上传下载主类.
 * @author fangxs
 * @className FastDFSClient
 * @date 2019/6/27 14:17
 * @description  FastDFS Java API. 文件上传下载主类.
 **/
...
public class FastDfsClient {
    ...
    private void initExt() {
        ...
        EXT_MAPS.put("jar", "application/x-java-archive");
        EXT_MAPS.put("tar", "application/x-tar");
        EXT_MAPS.put("7z", "application/x-7z-compressed");
        ...
        EXT_MAPS.put("docm", "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
    ...
    public String upload(String base64, String filename, Map<String, String> descriptions) throws FastDfsException {
        ...
        return upload(new ByteArrayInputStream(Base64.getDecoder().decode(base64)), filename, descriptions);
    }
